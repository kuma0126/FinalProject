...
//
        ...
        search_b.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                new FlightAsync().execute("http://aviation-edge.com/v2/public/flights?key=79ca4f-364b33&arrIata=" + eText.getText().toString());
                new FlightAsync().execute("http://aviation-edge.com/v2/public/flights?key=79ca4f-364b33&depIata=" + eText.getText().toString());
    ...
    public boolean dialogInfo() {
        ...
        activity_version.setText(getString(R.string.ativity_v) + ": ");
