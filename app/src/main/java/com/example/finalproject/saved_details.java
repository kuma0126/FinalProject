...
public class saved_details extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        TextView loc = findViewById(R.id.tView_saved_location);
        TextView speed = findViewById(R.id.tView_saved_speed);
        TextView alt = findViewById(R.id.tView_saved_altitude);
        TextView stat = findViewById(R.id.tView_saved_status);
        Button delete = findViewById(R.id.bDelete);
        TextView details=findViewById(R.id.tView_extra_details);
